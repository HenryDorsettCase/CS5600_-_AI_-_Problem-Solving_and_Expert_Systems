...
class Agent {
	...
	private boolean unlimitedArrows = false;
	...
	public Agent(Environment world, TransferPercept perceptTrans, boolean nonDeterministic, boolean unlimitedArrows) {
				
		// set deterministic/non-deterministic
		nonDeterministicMode = nonDeterministic;
		
		// set unlimited/limited arrows
