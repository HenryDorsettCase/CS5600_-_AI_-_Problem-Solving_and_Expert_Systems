...
public class AStarS_cycle_check_closed_list_Homegrown 
{
	Problem problem;
	long counter;
	long totalTimeMs;
	
	public AStarS_cycle_check_closed_list_Homegrown(Problem p)
	{
		this.problem = p;	
		counter = 0;
	}
	...
	public Node AStarSearch_cycle_check_closed_list_Homegrown()
	{
