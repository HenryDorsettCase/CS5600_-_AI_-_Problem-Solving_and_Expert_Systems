...
public class AStarS_cycle_check_closed_list_StraightLine 
{
	Problem problem;
	long counter;
	long totalTimeMs;
	
	public AStarS_cycle_check_closed_list_StraightLine(Problem p)
	{
		this.problem = p;	
		counter = 0;
	}
	...
	public Node AStarSearch_cycle_check_closed_list_StraightLine()
	{
