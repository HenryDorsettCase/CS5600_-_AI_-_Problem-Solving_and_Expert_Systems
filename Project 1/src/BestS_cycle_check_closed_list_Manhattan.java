...
public class BestS_cycle_check_closed_list_Manhattan  
{
	Problem problem;
	long counter;
	long totalTimeMs;
	
	public BestS_cycle_check_closed_list_Manhattan (Problem p)
	{
		this.problem = p;	
		counter = 0;
	}
	...
	public Node BestSearch_cycle_check_closed_list_Manhattan ()
	{
