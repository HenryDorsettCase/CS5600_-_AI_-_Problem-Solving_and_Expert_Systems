...
class Simulation {
	...
	public Simulation(Environment wumpusEnvironment, int maxSteps, boolean nonDeterministic, boolean unlimitedArrows) { //, BufferedWriter outWriter, boolean nonDeterministic) {
		...
		agent = new Agent(environment, transferPercept, nonDeterministic, unlimitedArrows);
